        ...
        <div class="col">
          <div class="description">
            ...
            <div class="youtube" v-if="article.url_youtube">
              <iframe width="560" height="315" frameborder="0" :src="getUrllYuotubeVideo(article.url_youtube)"
          ...
          <div class="visibility">
            ...
            <img v-if="article.like_user" src="../assets/icons/like.png" alt="" srcset="" style="padding-left: 10px"
                 @click="addLike(article.id, article.like_user)">
            <img v-else src="../assets/icons/like_.png" alt="" srcset="" style="padding-left: 10px"
                 @click="addLike(article.id, article.like_user)">
