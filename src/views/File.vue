        ...
        <div class="block-content">
            <div class="row-file" v-for="file in reversList" :key="file.id">
                <div class="col img">
                    ...
                    <img v-else-if="file.type_file == 'doc'| file.type_file == 'docx'" src="../assets/icons/doc.svg" alt="file icon" srcset="">
                    <img v-else-if="file.type_file == 'rar' | file.type_file == 'zip'" src="../assets/icons/zip.svg" alt="file icon" srcset="">
                ...
                <div class="col">
                    <div class="description">
                        ...
                        <button @click="download(file.id, file.title+'.'+file.type_file)">Скачать</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods:{
        ...
        download(id, name){
            this.$http.get( `${this.$store.getters.getServerUrl}/download/file/?id=${id}`).then(
                response => {
