  ...
  <div class="container" id="nav">
    <div class="header">
      ...
      <nav id='collapse' class="collapse" v-bind:class="{'collapse':!show, 'down': show}"
        ...
        <ul>
          <li class="nav-link"><a href="" v-bind:class="{'active':  path == 'Home'}" @click="goTo('Home')">Главная</a>
          </li>
          <li class="nav-link"><a href="" v-bind:class="{'active':  path == 'Blog'}" @click="goTo('Blog')">Новости</a>
          </li>
          <li class="nav-link"><a href="" v-bind:class="{'active':  path == 'File'}" @click="goTo('File')">Файлы</a>
          </li>
        </ul>
...
export default {
  ...
  methods: {
    ...
    printMousePos(event) {
      if (document.getElementsByClassName('collapse down').length > 0) {
